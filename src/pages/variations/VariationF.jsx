...
const VariationF = () => {
  ...
  return (
    <div className="modern-landing variation-f">
      {/* Orange Round Shapes Background */}
      <div className="orange-shapes-bg">
        ...
        <div className="shape-circle shape-7"></div>
        <div className="shape-circle shape-8"></div>
        <div className="shape-arc shape-arc-1"></div>
        <div className="shape-arc shape-arc-2"></div>
        <div className="shape-arc shape-arc-3"></div>
      </div>

      <section className="hero-split-screen hero-f">
